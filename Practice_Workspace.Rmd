...
##Test for normal distribution with Shapiro-Wilk’s test for normal distribution 
...
##Testing within each order to see if k_b_m has a statistically significant difference in any order. Might try to end up with a table of all cases of this for each person.
